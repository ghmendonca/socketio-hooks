...
**IMPORTANT** until we solve some issues it is recommended that you
put the Provider very close to the root of your app, similar to what you
would do with a Redux Provider
